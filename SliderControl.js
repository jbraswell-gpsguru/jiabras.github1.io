L.Control.SliderControl = L.Control.extend({
    options: {
        ...
        timeStrLength: 10,  // the size of  yyyy-mm-dd hh:mm:ss - if millis are present this will be larger//// formerly 19
        maxValue: -1,
        minValue: 0,
        showAllOnStart: true,
        markers: null,
    ...
    onAdd: function (map) {
        ...
        $(sliderContainer).append('<div id="leaflet-slider" style="width:200px"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:200px; margin-top:13px; background-color:#808080; text-align:center; border-radius:5px;"></div></div>');
